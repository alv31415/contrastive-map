...
def main(args):
    ...
    experiment_argss = [
        ...
        # 3) simclr, pre-trained resnet18, e = 25, batch size = 64, temperature = 0.95
        {
            ...
            # 17) simclr, pre-trained resnet18, e = 25, batch size = 32, ema tau= 0.99
            {
                "--batch-size": 32,
                "--patch-size": PATCH_SIZE,
                "--epochs": EPOCHS,
            ...
            # 18) byol, pre-trained resnet18, e = 25, batch size = 32, ema tau= 0.99
            {
                "--batch-size": 32,
                "--patch-size": PATCH_SIZE,
                "--epochs": EPOCHS,
            ...
            # 19) simclr, pre-trained resnet18, e = 25, batch size = 64, temperature = 0.99, lr = 1e-2
            {
                "--batch-size": BATCH_SIZE,
                "--patch-size": 128,
                "--epochs": EPOCHS,
            ...
            # 20) byol, pre-trained resnet18, e = 25, batch size = 64, ema tau = 0.99, lr = 1e-2
            {
                "--batch-size": BATCH_SIZE,
                "--patch-size": 128,
                "--epochs": EPOCHS,
    ...
    # 1) simclr, cnn, e = 25, batch size = 64, temperature = 0.99, geo-contrastive objective
    experiment_argss = [
        {
            "--batch-size": BATCH_SIZE,
            "--patch-size": PATCH_SIZE,
    ...
    # 2) simclr, not pre-trained resnet18, e = 25, batch size = 64, temperature= 0.99
                     {
                         "--batch-size": BATCH_SIZE,
                         "--patch-size": PATCH_SIZE,
                         "--epochs": 15,
        ...
        # 3) simclr, pre-trained resnet18, e = 25, batch size = 64, temperature= 0.80
        {
            "--batch-size": BATCH_SIZE,
            "--patch-size": PATCH_SIZE,
            "--epochs": 15,
